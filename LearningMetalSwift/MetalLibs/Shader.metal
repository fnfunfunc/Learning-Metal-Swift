...
vertex VertexOut vertex_main(VertexIn in [[stage_in]], constant NodeConstants& node[[buffer(2)]], constant FrameConstants& frame [[buffer(3)]]) {
...
fragment float4 fragment_main(VertexOut in [[stage_in]],
                              ...
                              texture2d<float, access::sample> textureMap [[texture(0)]], sampler textureSampler [[sampler(0)]]) {
